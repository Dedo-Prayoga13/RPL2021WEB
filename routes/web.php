...
Route::post('/mahasiswa/insertSuratKet', 'MahasiswaController@AjukanSurat');
...
Route::get('/koor/setUjian', 'KoorController@SetUjianK');
Route::post('/koor/setUjian', 'KoorController@SetUjianK');
